...
public final class LiftsContract {
    ...
    public static class Lifts implements BaseColumns {
        ...
        public static final String COLUMN_NAME_REPSCHEME = "repscheme";
        public static final String COLUMN_NAME_COMPOUND = "compound";
    ...
    public static class Sets implements BaseColumns {
        ...
        public static final String COLUMN_NAME_ORDER = "ordering";
    ...
    public static class Cycles implements BaseColumns {
        ...
        public static final String COLUMN_NAME_PRESS = "press";
        public static final String COLUMN_NAME_DEAD = "dead";
        public static final String COLUMN_NAME_BENCH = "bench";
        public static final String COLUMN_NAME_SQUAT = "squat";

    }

    public static class MaxesXlifts {
        public static final String VIEW_NAME = "maxesXlifts";
        public static final String COLUMN_NAME_DATE = "date";
        public static final String COLUMN_NAME_LIFT = "lift";
        public static final String COLUMN_NAME_WEIGHT = "weight";
        public static final String COLUMN_NAME_LIFTID = "lift_id";
    }
